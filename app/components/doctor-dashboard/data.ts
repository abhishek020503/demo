...
export const DOCTOR_BIOHACK_DATA = [
  ...
  { label: "Visceral Fat", value: "11", status: "Watch" },
...
export const DOCTOR_SMARTWATCH_DATA = [
  ...
  { label: "HRV", value: "42 ms", status: "Average" },
  ...
  { label: "Step Count", value: "7,420", status: "Moderate" },
  { label: "Sleep Tracking", value: "6.8 hrs", status: "Watch" },
  { label: "VO2 Max", value: "31 ml/kg/min", status: "Moderate" },
];
