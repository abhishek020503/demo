...
export default function PatientOverview({
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/60 md:p-2">
      ...
      <div className="motion-fade-up relative flex flex-wrap items-start justify-between gap-4">
        <div>
      ...
      <div className="motion-fade-up motion-delay-1 relative mt-8 grid grid-cols-1 gap-6 xl:grid-cols-[1.2fr_1fr]">
          ...
          {moduleLinks.length > 0 ? (
            moduleLinks.map((module, index) => (
              <Link
                key={module.href}
                href={module.href}
                className="motion-fade-up rounded-xl border border-slate-200 bg-white px-2.5 py-1.5 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:bg-slate-50"
        ...
        <div className="motion-fade-up motion-delay-2 rounded-2xl bg-slate-900 p-1 text-slate-100 shadow-lg shadow-slate-300/40 md:p-2">
