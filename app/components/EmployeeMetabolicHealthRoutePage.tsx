...
import EmployeeMetabolicHealthPage from "./employee-dashboard/EmployeeMetabolicHealthPage";

export default function EmployeeMetabolicHealthRoutePage() {
  return (
