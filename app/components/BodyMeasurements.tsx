      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            aria-label="Inspect anatomy map"
          >
            <ScanSearch size={18} />
          </button>
        </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="rounded-[1.4rem] border border-white/60 bg-white/50 p-3.5 shadow-lg backdrop-blur-md">
            ...
            <div className="mt-3 space-y-2.5">
              <SidebarRow icon={Brain} label="Brain" value="Cognitive focus" />
              <SidebarRow icon={Heart} label="Heart" value="Pulse marker" />
              <SidebarRow icon={Info} label="Overlay" value="Abstract body mapping" />
            </div>
          </div>
        </div>
      </div>
