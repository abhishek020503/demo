...
function ReportWaveHeader({ mode }: { mode: "cover" | "section" }) {
  return (
    <div className="relative isolate overflow-hidden">
      <div
        className="relative px-10 pb-20 pt-8 text-white"
        style={{
        ...
        <div className="flex items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="mt-1 text-[10px] font-medium tracking-widest text-teal-50 uppercase opacity-80">
...
export default function BloodParametersReport() {
  ...
  const downloadPDF = useCallback(async () => {
    ...
    try {
      const pageIds = ["reportPage1", "reportPage3", "reportPage4", "reportPage5", "reportPage6"];
  ...
  return (
    <div className="min-h-screen py-8 px-4 print:py-0 print:px-0" style={{ background: `linear-gradient(to bottom, ${PURPLE.bg} 0%, #ffffff 100%)` }}>
      {printStyles}
      <div className="mx-auto max-w-[794px]">
        <div className="mb-6 flex gap-4 justify-end print:hidden">
          ...
          >
            {isGenerating ? <Loader2 className="h-5 w-5 animate-spin" aria-hidden="true" /> : <Download className="h-5 w-5" aria-hidden="true" />}
        ...
        <div className="mb-6 grid gap-4 md:grid-cols-2 print:hidden">
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">3.1 Blood Report</p>
            <h2 className="mt-1 text-2xl font-semibold text-slate-900">Current Blood Report</h2>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">3.2 Old Blood Reports</p>
            <h2 className="mt-1 text-2xl font-semibold text-slate-900">Previous Report History</h2>
          </div>
        </div>
        ...
        <div id="reportContent" className="space-y-6">
              ...
              <div className="flex flex-1 flex-col p-12 pt-0">
                ...
                <div className="mt-2 flex flex-col items-center gap-4 lg:flex-col">
                  <div className="relative h-[300px] w-full max-w-[500px] shrink-0">
                    ...
                    <ResponsiveContainer ready={chartsReady} width="100%" height="100%">
                      <RadarChart data={RADAR_DATA} outerRadius="75%">
                        ...
                        <Radar
                          ...
                          label={(props) => {
                            ...
                            if (x == null || y == null || value == null || value === false) {
                              return null;
                            }
                            return (
                  ...
                  <div className="w-full flex-1">
                    <div className="mt-4 grid grid-cols-2 gap-3">
                      {[HEALTH_SCORECARD.slice(0, 4), HEALTH_SCORECARD.slice(4, 8)].map((col, colIdx) => (
                ...
                <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50/50 p-5 ring-1 ring-slate-200/50">
                  <h3 className="text-[11px] font-black uppercase tracking-[0.15em] text-slate-500">
                    Bone Health Index Reference
                  </h3>
                  <div className="mt-3 grid grid-cols-2 gap-3">
                    {BHI_RANGES.map((item) => (
                      <div key={item.range} className="rounded-xl border border-slate-200 bg-white p-3">
                        <div className="text-sm font-black text-slate-900">{item.range}</div>
            ...
            <div className="flex min-h-[1123px] flex-col">
              ...
              <div className="flex flex-1 flex-col p-12 pt-0">
                ...
                <div className="mt-2 grid grid-cols-2 gap-2">
                  {[AYURVEDA_PARAMS.slice(0, 5), AYURVEDA_PARAMS.slice(5, 10)].map((col, colIdx) => (
                    <div key={`col-${colIdx}`} className="space-y-2">
                      {col.map((p) => (
                          ...
                          <div className="mt-2">
                            <div style={{ height: 40 }} className="relative">
                              ...
                              <ResponsiveContainer ready={chartsReady} width="100%" height="100%">
                                <BarChart
                                  layout="vertical"
                                  data={[{ name: p.name, valueFromMid: ((Number(p.value) || 0) - 50) * 2 }]}
                                ...
                                >
                                  ...
                                  <Bar dataKey="valueFromMid" barSize={10} radius={[4, 4, 4, 4]} isAnimationActive={false} fill={getBarColor(Number(p.value) || 0)} />
                  ...
                  {DHATU.map((item) => (
                    <div key={item.name} className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <p className="text-sm font-black text-teal-600">{item.value}</p>
                      </div>
                ...
                <div className="mt-6" style={{ height: chartHeight }}>
                  <ResponsiveContainer ready={chartsReady} width="100%" height="100%">
                    <LineChart data={AYURVEDA_PARAMS}>
                      <CartesianGrid strokeDasharray="3 3" stroke={BRAND.slate[100]} />
                      <XAxis dataKey="name" hide />
                      <YAxis domain={[0, 100]} tick={{ fontSize: 10, fill: BRAND.slate[400] }} />
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="value" stroke={BRAND.primary} strokeWidth={3} dot={{ r: 4 }} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
          ...
          <div className="report-page rounded-2xl border border-slate-200 bg-white p-6 shadow-sm print:hidden">
            <h2 className="flex items-center gap-2 text-xl font-black tracking-tight text-slate-900">
              <ClipboardList className="h-5 w-5 text-teal-600" />
              3.2 Old Blood Reports
            </h2>
            <div className="mt-4 grid gap-3 sm:grid-cols-3">
              {[
                { date: "12 Jan 2026", note: "Vitamin D low, CRP borderline" },
                { date: "17 Sep 2025", note: "HbA1c elevated, inflammation low" },
                { date: "24 Apr 2025", note: "General chemistry stable, lipid watch" },
              ].map((item) => (
                <div key={item.date} className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                  <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-slate-500">Report Date</p>
